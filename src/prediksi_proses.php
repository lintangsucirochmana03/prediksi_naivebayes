...
<?php
    ...
    mysqli_query($connect,"INSERT INTO MahasiswaHasil (Nim, Nama, JurusanAsal,Prodi,IPS1,IPK,TotalSKS,JumD,JumE,Status_Lulus,Prediksi)
        VALUES ('".$nimi['nim']."','".$nama['nama']."','".$jurusan_asal['jurusan_asalsekolah']."','".$prodinew['prodi']."','".$ipsnew['ips1']."','".$ipknew['ipk4']."','".$tot_sksnew['tot_sks4']."','".$jumD4new['jumD4']."','".$jumE4new['jumE4']."','".$status_lulus['status']."','".$prediksi['Prediksi']."'); ");
    $loop+=1;
    };
