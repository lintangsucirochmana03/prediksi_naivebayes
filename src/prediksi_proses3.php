<?php
    ...
    $ipknew=mysqli_fetch_assoc(mysqli_query($connect,"SELECT ipk4 FROM mahasiswa WHERE nim=".$hasilarray[$minout-1].";") );

    $tot_sksnew=mysqli_fetch_assoc(mysqli_query($connect,"SELECT tot_sks4 FROM Mahasiswa WHERE nim=".$hasilarray[$minout-1].";"));

    $jumD4new=mysqli_fetch_assoc(mysqli_query($connect,"SELECT jumD4 FROM Mahasiswa WHERE nim=".$hasilarray[$minout-1].";"));

    $jumE4new=mysqli_fetch_assoc(mysqli_query($connect,"SELECT jumE4 FROM Mahasiswa WHERE nim=".$hasilarray[$minout-1].";"));
    ...
    mysqli_query($connect,"INSERT INTO MahasiswaHasil (Nim,JurusanAsal,Prodi,IPS1,IPK,TotalSKS,JumD,JumE,Status_Lulus,Prediksi)
        VALUES ('".$nimi['nim']."','".$jurusan_asal['jurusan_asalsekolah']."','".$prodinew['prodi']."','".$ipsnew['ips1']."','".$ipknew['ipk4']."','".$tot_sksnew['tot_sks4']."','".$jumD4new['jumD4']."','".$jumE4new['jumE4']."','".$status_lulus['status']."','".$prediksi['Prediksi']."'); ");
    $loop+=1;
    };
