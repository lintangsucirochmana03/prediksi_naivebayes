<?php
    ...
    $ipsnew=mysqli_fetch_assoc(mysqli_query($connect,"SELECT ips1, IF(ips1>=2.00, ips1, '3.00') As ips1minim FROM mahasiswa WHERE nim=".$hasilarray[$minout-1].";") );

    $ipknew=mysqli_fetch_assoc(mysqli_query($connect,"SELECT ipk, IF(ipk>=2.00, ipk, '3.00') As ipkminim FROM mahasiswa WHERE nim=".$hasilarray[$minout-1].";") );
